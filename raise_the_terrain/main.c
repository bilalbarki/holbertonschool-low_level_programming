    ...
    else
    {
        ...
        while (quit) {
            ...
            while( SDL_PollEvent( &e ) != 0 )
            {
				...
				int x_center = (SCREEN_WIDTH / 2)-(incline)*tile_dimension;
				int y_center = ((SCREEN_HEIGHT / 2) - hyp)+(incline)* tile_dimension;
                    ...
                    for( int i = 0, k=0; i < (tiles)*tile_dimension; i += tile_dimension, k++)
                    {
                       ...
                       if (MouseOver == 0 && !normalize) {
                                    ...
                                    bg.r = 0xFF;
                                        ...
                                        SDL_Surface *textsurface = TTF_RenderText_Shaded(font, coordtext, textColor, bg);
                                        if (textsurface != NULL)
                                        {
                                            if (texture != NULL) {
                                                SDL_DestroyTexture( texture );
                                            ...
                                            if (texture != NULL)
                                            {
                                                ...
                                                SDL_Rect rect = {abs(toolX-20), abs(toolY-25) - tooloffset, 70, 15};
